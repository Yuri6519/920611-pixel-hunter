...
import {AbstractPresenter, AbstrModel} from '../../../common/index';
...
import {
  ...
  RESP_FAIL,
  IGameModel} from '../../../common/constants/index';
...
export default class GamePresenter extends AbstractPresenter {
  ...
  private _header: HeaderPresenter;
  private _headerElement: HTMLElement;
  private _gameElement: HTMLElement;
  private _footer: FooterPresenter;
  ...
  closeModal() {
    Appl.showCurrentElement(this._root);
  }

  onButtonBackClick() {
    Appl.showDialog(this.confirmModal.bind(this), this.closeModal.bind(this));
  ...
  get resp() {
    ...
    const result: Array<any> = resp.slice(0);
